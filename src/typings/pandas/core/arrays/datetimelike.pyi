...
class DatetimeLikeArrayMixin(OpsMixin, NDArrayBackedExtensionArray):
    ...
    def astype(self, dtype, copy: bool = ...): # -> NDArray[object_] | ndarray[Any, Any] | ExtensionArray | NDArray[int64] | NDArray[Any]:
        ...
    ...
    def __sub__(self, other): # -> _NotImplementedType | TimedeltaArray | DatetimeArray | PeriodArray | ndarray[Any, dtype[Any]] | ndarray[Any, Any] | ndarray[Any, dtype[object_]]:
        ...
    
    def __rsub__(self, other): # -> _NotImplementedType | TimedeltaArray | DatetimeArray | PeriodArray | ndarray[Any, dtype[Any]] | ndarray[Any, Any] | ndarray[Any, dtype[object_]]:
        ...
...
class TimelikeOps(DatetimeLikeArrayMixin):
    ...
    def factorize(self, use_na_sentinel: bool = ..., sort: bool = ...): # -> tuple[ndarray[Any, dtype[signedinteger[_NBitIntP]]], Self] | tuple[ndarray[Any, Any], ExtensionArray]:
        ...
