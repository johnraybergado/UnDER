...
from pandas._typing import Axis, AxisInt, Self
...
def convert_missing_indexer(indexer): # -> tuple[Any, Literal[True]] | tuple[Any, Literal[False]]:
    """
...
def convert_from_missing_indexer_tuple(indexer, axes): # -> tuple[Any, ...]:
    """
    Create a filtered indexer that doesn't have any missing indexers.
    """
    ...

def maybe_convert_ix(*args): # -> tuple[Any, ...] | tuple[ndarray[Any, Any], ...]:
    """
