...
class MultiIndex(Index):
    ...
    def get_loc(self, key): # -> Any | slice[NDArray[intp] | intp, NDArray[intp] | intp, Any] | ndarray[Any, Any] | ndarray[Any, dtype[bool_]] | ndarray[Any, dtype[Any]] | slice[Any, Any, Any] | int | integer[Any] | slice[int, int, Any] | ndarray[Any, dtype[signedinteger[_NBitIntP]]] | None:
        """
