...
class Term(ops.Term):
    env: PyTablesScope
    def __new__(cls, name, env, side=..., encoding=...): # -> Self | Constant:
        ...
...
class BinOp(ops.BinOp):
    ...
    def prune(self, klass): # -> ConditionBinOp | FilterBinOp | JointConditionBinOp | JointFilterBinOp:
        ...
    
    def conform(self, rhs): # -> ndarray[Any, Any] | list[Any]:
        """inplace conform rhs"""
        ...
...
class FilterBinOp(BinOp):
    ...
    def generate_filter_op(self, invert: bool = ...): # -> Callable[..., Any]:
        ...
...
class PyTablesExprVisitor(BaseExprVisitor):
    ...
    def visit_Attribute(self, node, **kwargs): # -> Term | Constant | Any:
        ...
    
    def translate_In(self, op): # -> Eq:
        ...
