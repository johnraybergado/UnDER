...
class Window(BaseWindow):
    ...
    **on**
    ...
    def sum(self, numeric_only: bool = ..., **kwargs): # -> Series | DataFrame | Any | ndarray[Any, Any] | NDArray[Any]:
        ...
    ...
    def mean(self, numeric_only: bool = ..., **kwargs): # -> Series | DataFrame | Any | ndarray[Any, Any] | NDArray[Any]:
        ...
    ...
    def var(self, ddof: int = ..., numeric_only: bool = ..., **kwargs): # -> Series | DataFrame | Any | ndarray[Any, Any] | NDArray[Any]:
        ...
    ...
    def std(self, ddof: int = ..., numeric_only: bool = ..., **kwargs): # -> Any:
        ...
    


class RollingAndExpandingMixin(BaseWindow):
    def count(self, numeric_only: bool = ...): # -> DataFrame | Series:
        ...
    
    def apply(self, func: Callable[..., Any], raw: bool = ..., engine: Literal["cython", "numba"] | None = ..., engine_kwargs: dict[str, bool] | None = ..., args: tuple[Any, ...] | None = ..., kwargs: dict[str, Any] | None = ...): # -> DataFrame | Series:
        ...
    
    def sum(self, numeric_only: bool = ..., engine: Literal["cython", "numba"] | None = ..., engine_kwargs: dict[str, bool] | None = ...): # -> DataFrame | Series | Any:
        ...
    
    def max(self, numeric_only: bool = ..., engine: Literal["cython", "numba"] | None = ..., engine_kwargs: dict[str, bool] | None = ...): # -> DataFrame | Series | Any:
        ...
    
    def min(self, numeric_only: bool = ..., engine: Literal["cython", "numba"] | None = ..., engine_kwargs: dict[str, bool] | None = ...): # -> DataFrame | Series | Any:
        ...
    
    def mean(self, numeric_only: bool = ..., engine: Literal["cython", "numba"] | None = ..., engine_kwargs: dict[str, bool] | None = ...): # -> DataFrame | Series | Any:
        ...
    
    def median(self, numeric_only: bool = ..., engine: Literal["cython", "numba"] | None = ..., engine_kwargs: dict[str, bool] | None = ...): # -> DataFrame | Series:
        ...
    
    def std(self, ddof: int = ..., numeric_only: bool = ..., engine: Literal["cython", "numba"] | None = ..., engine_kwargs: dict[str, bool] | None = ...): # -> Any | DataFrame | Series:
        ...
    
    def var(self, ddof: int = ..., numeric_only: bool = ..., engine: Literal["cython", "numba"] | None = ..., engine_kwargs: dict[str, bool] | None = ...): # -> Series | Any | DataFrame:
        ...
    
    def skew(self, numeric_only: bool = ...): # -> DataFrame | Series:
        ...
    
    def sem(self, ddof: int = ..., numeric_only: bool = ...): # -> Any:
        ...
    
    def kurt(self, numeric_only: bool = ...): # -> DataFrame | Series:
        ...
    
    def quantile(self, q: float, interpolation: QuantileInterpolation = ..., numeric_only: bool = ...): # -> DataFrame | Series:
        ...
    
    def rank(self, method: WindowingRankType = ..., ascending: bool = ..., pct: bool = ..., numeric_only: bool = ...): # -> DataFrame | Series:
        ...
    
    def cov(self, other: DataFrame | Series | None = ..., pairwise: bool | None = ..., ddof: int = ..., numeric_only: bool = ...): # -> DataFrame | Series:
        ...
    
    def corr(self, other: DataFrame | Series | None = ..., pairwise: bool | None = ..., ddof: int = ..., numeric_only: bool = ...): # -> DataFrame | Series:
        ...
...
class Rolling(RollingAndExpandingMixin):
    ...
    @doc(template_header, create_section_header("Parameters"), window_apply_parameters, create_section_header("Returns"), template_returns, create_section_header("See Also"), template_see_also, create_section_header("Examples"), dedent("""\
    ...
    def max(self, numeric_only: bool = ..., *args, engine: Literal["cython", "numba"] | None = ..., engine_kwargs: dict[str, bool] | None = ..., **kwargs): # -> DataFrame | Series | Any:
        ...
