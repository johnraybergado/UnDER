...
if TYPE_CHECKING:
    ...
_hashtables = ...
def unique(values): # -> ArrayLike | tuple[ArrayLike, NDArray[Any] | Any]:
    """
...
def unique_with_mask(values, mask: npt.NDArray[np.bool_] | None = ...): # -> ArrayLike | tuple[ArrayLike, NDArray[Any] | Any]:
...
def take(arr, indices: TakeIndexer, axis: AxisInt = ..., allow_fill: bool = ..., fill_value=...): # -> ndarray[Any, dtype[Any]] | ndarray[Any, Any] | Index | Series:
    """
...
_diff_special = ...
def diff(arr, n: int, axis: AxisInt = ...): # -> Any | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[signedinteger[_64Bit] | object_ | floating[_32Bit] | floating[_64Bit] | Any]]:
    """
