...
import textwrap
import numpy as np
from typing import Any, Generic, Literal, TYPE_CHECKING, final, overload
from pandas._typing import AxisInt, DropKeep, DtypeObj, IndexLabel, NDFrameT, NumpySorter, NumpyValueArrayLike, ScalarLike_co, Self, Shape, npt
...
class IndexOpsMixin(OpsMixin):
    ...
    def unique(self): # -> ArrayLike | tuple[ArrayLike, NDArray[Any] | Any]:
        ...
    ...
    @doc(algorithms.factorize, values="", order="", size_hint="", sort=textwrap.dedent("""\
