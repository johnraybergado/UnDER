...
from pandas._typing import ArrayLike, AxisInt, CorrelationMethod, Dtype, F, npt
...
@bottleneck_switch()
def nanmedian(values, *, axis: AxisInt | None = ..., skipna: bool = ..., mask=...): # -> NDArray[Any]:
    """
    Parameters
    ----------
    values : ndarray
...
def nanstd(values, *, axis: AxisInt | None = ..., skipna: bool = ..., ddof: int = ..., mask=...): # -> NDArray[Any]:
    """
...
@disallow("M8", "m8")
def nancorr(a: np.ndarray, b: np.ndarray, *, method: CorrelationMethod = ..., min_periods: int | None = ...) -> float:
    """
    a, b: ndarrays
    """
    ...
...
@disallow("M8", "m8")
def nancov(a: np.ndarray, b: np.ndarray, *, min_periods: int | None = ..., ddof: int | None = ...) -> float:
    ...
