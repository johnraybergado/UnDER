...
_canonical_nans = ...
def maybe_promote(dtype: np.dtype, fill_value=...): # -> tuple[dtype[Any], DTScalarOrNaT | float | object | Any | int64 | datetime64 | timedelta64 | ndarray[Any, Any] | bool | bool_ | int | integer[Any] | complex]:
    """
