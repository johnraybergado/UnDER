...
def infer_fill_value(val): # -> NDArray[Any] | float:
    """
...
def na_value_for_dtype(dtype: DtypeObj, compat: bool = ...): # -> object | Any | float | Literal[0, False]:
    """
...
def remove_na_arraylike(arr: Series | Index | np.ndarray): # -> Series | Any | ndarray[Any, Any] | NDArray[Any] | Index:
    """
