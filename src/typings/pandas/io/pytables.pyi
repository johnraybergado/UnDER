...
class DataCol(IndexCol):
    ...
    def convert(self, values: np.ndarray, nan_rep, encoding: str, errors: str): # -> tuple[Any | None, ndarray[Any, Any] | NDArray[Any] | Categorical | Any]:
        """
        Convert the data from this selection to the appropriate pandas type.
...
class Selection:
    ...
    def select_coords(self): # -> Any | ndarray[Any, dtype[Any]] | NDArray[Any]:
        """
        generate the selection
        """
        ...
