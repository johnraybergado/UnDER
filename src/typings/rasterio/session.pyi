...
class Session:
    ...
    @staticmethod
    def cls_from_path(path): # -> type[DummySession] | type[AWSSession] | type[OSSSession] | type[SwiftSession] | type[AzureSession]:
    ...
    @staticmethod
    def from_path(path, *args, **kwargs): # -> AWSSession | AzureSession | DummySession | OSSSession | SwiftSession:
...
class AzureSession(Session):
    ...
    @property
    def credentials(self): # -> dict[str, Any] | dict[str, Any | str | None]:
        """The session credentials as a dict"""
        ...
    
    def get_credential_options(self): # -> dict[str, Any] | dict[str, Any | str | None]:
        """Get credentials as GDAL configuration options
