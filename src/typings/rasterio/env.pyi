...
class Env:
    ...
    def aws_creds_from_context_options(self): # -> dict[Any, Any]:
        ...
...
def ensure_env_credentialled(f): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
    """DEPRECATED alias for ensure_env_with_credentials"""
    ...

def ensure_env_with_credentials(f): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
...
def require_gdal_version(version, param=..., values=..., is_max_version=..., reason=...): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
