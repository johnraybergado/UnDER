...
@ensure_env
def transform(src_crs, dst_crs, xs, ys, zs=...): # -> tuple[list[Any], list[Any], list[Any]] | tuple[list[Any], list[Any]]:
...
def transform_geom(src_crs, dst_crs, geom, antimeridian_cutting=..., antimeridian_offset=..., precision=...):
...
def transform_bounds(src_crs, dst_crs, left, bottom, right, top, densify_pts=...):
...
@ensure_env
def reproject(source, destination=..., src_transform=..., gcps=..., rpcs=..., src_crs=..., src_nodata=..., dst_transform=..., dst_crs=..., dst_nodata=..., dst_resolution=..., src_alpha=..., dst_alpha=..., masked=..., resampling=..., num_threads=..., init_dest_nodata=..., warp_mem_limit=..., src_geoloc_array=..., **kwargs):
...
def aligned_target(transform, width, height, resolution): # -> tuple[Affine, int, int]:
...
@ensure_env
def calculate_default_transform(src_crs, dst_crs, width, height, left=..., bottom=..., right=..., top=..., gcps=..., rpcs=..., resolution=..., dst_width=..., dst_height=..., src_geoloc_array=..., **kwargs): # -> tuple[Affine | Any, Any | None, Any | None]:
