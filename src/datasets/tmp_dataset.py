...
class TMPDataset(Dataset):
    def __init__(self, datapath, list_filename, training, height_snap, width_snap):
        ...
        self.height_snap = height_snap
        self.width_snap = width_snap
        if self.training:
    ...
    def __getitem__(self, index):
        ...
        if self.training:
            ...
            # top_pad = 1408 - h
            # right_pad = 1792 - w
            top_pad = self.height_snap - h
            right_pad = self.width_snap - w
